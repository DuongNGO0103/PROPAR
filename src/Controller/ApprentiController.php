...
class ApprentiController extends AbstractController
{
    ...
    /**
     * @Route("/apprenti/operationsliste", name="app_liste_operations_apprenti")
     */
     ...
     */
    public function terminerOperation(KernelInterface $kernelInterface, MailerService $mailer, Commande $commandes = null, EntityManagerInterface $entityManager): Response
    {
     ...
     */
    public function comfirmerOperation(Commande $commandes = null, EntityManagerInterface $entityManager, CommandeRepository $repository): Response
    {
        if (!$commandes) {
            $commandes = new Commande();
        }
